...
@section('admincontenent')
    <div class="col-md-12">
        ...
        <div class="col-md-4 col-sm-4">
                    <div class="col-sm-12">
                            <img src="{{asset('assets/img/about')}}/{{$data->backimg}}" class="img-thumbnail" style="width:100">
                        <div>
            ...
            <div class="col-md-8 col-sm-8">
                ...
                <form method="post" action="{{route('addupdourcmg',$data->id)}}">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="logo_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form method="post" action="{{route('addupdourcmg',$data->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <img src="{{asset('assets/img/about')}}/{{$data->backimg}}" class="img-thumbnail" style="width:200px">
                    <div>
                        <input type="text" name="id" value="{{$data->id}}" hidden>
