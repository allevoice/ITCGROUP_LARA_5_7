...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Editer {{$data->title}}
            <a href="{{route('listsldheader')}}" class="btn btn-md btn-primary"><i class="glyphicon glyphicon-arrow-left"></i></a>
        </h2>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="col-sm-12">
                <img src="{{asset('assets/img/banners')}}/{{$data->backimgview}}" class="img-thumbnail" style="width:100">
                <div>
            ...
            <form method="post" action="{{route('addupdsldheader',$data->id)}}">
                @csrf
                @method('PUT')
                ...
                <input type="text" name="indice" value="3" hidden>
                    ...
                    <div class="form-group text-center">
                        <div class="col-xs-6">
                            <a href="{{route('listsldheader')}}" class="btn btn-danger" type="button">Retour</a>
                        </div>
                        <div class="col-xs-6">
                            <label>
...
<div class="modal fade" id="logo_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form method="post" action="{{route('addupdsldheader',$data->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
