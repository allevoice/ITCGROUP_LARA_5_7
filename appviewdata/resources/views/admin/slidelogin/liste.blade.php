...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Shows liste
            <a href="{{route('newsldlogin')}}" class="btn btn-sm btn-primary">+</a>
            <a href="{{route('sldloginlstdel')}}" class="btn btn-xs btn-danger">Del</a>
        </h2>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td class="center" width="200">
                                        <img src="{{asset('assets/img/login/')}}/{{$show->backimgview}}" class="img-thumbnail">
                                </td>
                                ...
                                <td width="100">
                                    <form action="{{route('delsldlogin',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('editsldlogin',$show->id)}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></a>
                        ...
                        @empty
                            <tr>
                                <td colspan="4"> <center><a href="{{route('addstsldlogin')}}">New Default Data</a></center>  </td>
                            </tr>
