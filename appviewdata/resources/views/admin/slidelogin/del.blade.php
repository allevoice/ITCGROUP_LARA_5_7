...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Delete liste
            <a href="{{route('listsldlogin')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-arrow-left"></i></a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td class="center">
                                        <img src="{{asset('assets/img/login/')}}/{{$show->backimgview}}" class='img-thumbnail' width="100">
                                </td>
                                ...
                                <td width="100">
                                    <form action="{{route('sldlogindelete',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('restdelsldlogin',$show->id)}}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-transfer"></i></a>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <img src="{{asset('assets/img/login/')}}/{{$show->backimgview}}" class="img-thumbnail" width="200">
                                                    </div>
                                                </div>
                                            </div>
