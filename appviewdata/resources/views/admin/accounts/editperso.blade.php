                ...
                <form method="post" action="{{route('updateaccount',$data->id)}}">
                    ...
                    <div class="form-horizontal col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="status" value="{{statuscmd($data->status)}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label>
                                    <input type="text" class="form-control" name="level" value="{{levelrolecmd($data->level)}}" readonly>
                                </label>
                            </div>
                        </div>
